        ...
        try:
            ...
            if aircraft:
                ...
                if settings.debug_mode:
                    ...
                    text_life = self.font.render("Life: " + str(aircraft.bearing_diff), True, settings.green)
                ...
                if settings.debug_mode:
                    self.panel_surface.blit(text_x, (10, settings.text_spacer * 11))
                    self.panel_surface.blit(text_y, (10, settings.text_spacer * 12))
                    self.panel_surface.blit(text_life, (10, settings.text_spacer * 14))
